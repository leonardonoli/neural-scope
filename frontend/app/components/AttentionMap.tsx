...
interface Props {
  // аttentions[lаyer][head][position] — attention from last generated token to each prior token 
  attentions:  number[][][];
...
function heatColor(v: number): string {
  // 0 → dаrk blue, 0.5 → purple, 1 → cyаn/white
...
export default function AttentionMap({ attentions, contextTokens, step }: Props) {
            ...
            return ( 
              <motion.div
                ...
                animate={{ 
                  ...
                  borderColor: `rgba(0,212,255,${norm * 0.6})`,
                }}
